...
\caption{Distributions of the measured refractive index (top plot), $A_0$ (in percent, central plot), and $L_{scatt}$
  (bottom plot) for the square 2~cm tiles. The red dashed lines indicate the specification limits.}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=1.05\columnwidth]{Electron_PID.png}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=1.05\columnwidth]{Hadron_PID.png}
\end{center}
