...
\begin{abstract}
  A ring imaging Cherenkov (RICH) detector has been installed in the CLAS12 spectrometer at Jefferson Laboratory (JLab)
  to provide kaon identification in the momentum range between 3~GeV/c and 8~GeV/c. The detector adopts a hybrid optics
...
\includegraphics[width=0.45\textwidth]{Aero_Refind.png}
\includegraphics[width=0.45\textwidth]{Aero_A0.png}
\includegraphics[width=0.45\textwidth]{Aero_Lscatt.png}
...
%The flat panel Hamamatsu H8500 multi-anode photoMultiplier tube (\MaPMT)~\cite{Ref:H8500} was selected to achieve the design angular resolution, thanks to the enhanced sensitivity to the visible and near-UV light in conjunction with a matching geometrical layout of 64 pixels covering a 5x5 $\rm cm^2$ area with an excellent packing factor of 89\%.
...
%To approximate the performance of the first amplification cascade of the MaPMT the probability function $T(n,m;\bf{t})$ was introduced in the model as trinomial sum of three Poissonian with different average secondary multiplicities and the corresponding three relative probabilities for every photoelectron to generate secondary electrons, here $m$ is the number of the electrons knocked out from the first dynode and $n$ is the number of electrons emitted out of the second dynode.
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=1.00\columnwidth]{dt_vs_anode_nocor.png}
\includegraphics[width=1.00\columnwidth]{dt_vs_dur_nocor.png}
\end{center}
...
\begin{figure*}[!ht]
\begin{center}
\includegraphics[width=1.8\columnwidth]{Event_21488.png}
\end{center}
...
\begin{figure*}[!ht]
\begin{center}
\includegraphics[width=1.8\columnwidth]{Event_13051.png}
\end{center}
...
\begin{figure*}[!ht]
\begin{center}
\includegraphics[width=1.8\columnwidth]{Event_11846.png}
\end{center}
...
\begin{figure*}[!ht]
\begin{center}
\includegraphics[width=1.8\columnwidth]{Event_20155.png}
\end{center}
...
%Such preliminary Cherenkov angle resolution is already sufficient for an effective hadron
%separation in the goal range of momenta, from 3~GeV/c to 8~GeV/c, as shown by Figs.~\ref{Fig:CHele} to \ref{Fig:CHhad2}.
